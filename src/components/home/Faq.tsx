...
const faqs = [
  {
    ...
    details:
      "dApp is a decentralized application that runs on a blockchain network.",
  },
  {
    summary: "How do Dapps Work?",
    details:
      "dApps work by using smart contracts to execute code on the blockchain.",
  },
  {
    summary: "What are the benefits of Dapp?",
    details:
      "dApps offer increased security, transparency, and immutability compared to traditional applications.",
  },
  {
    summary: "What are the Features of  this Dapp?",
    details:
      "This dApp features a user-friendly interface, secure transactions and decentralized storage.",
  },
  {
    summary: "How does it Function?",
    details:
      "This dApp functions by connecting users directly to the blockchain network, allowing them to interact with smart contracts and other dApps.",
  },
];
