...
const navLinks = [
  ...
  { title: "Voting System", href: "#" },
  { title: "Strategy", href: "#" },
  { title: "FAQs", href: "#section_faqs" },
];
const Header = () => {
        ...
        <nav className="flex justify-between items-center pb-5 pt-6">
          <div className="flex items-center gap-20">
            <div className="relative h-10 aspect-[2/1]">
              {/* <Image layout="fill" src="/logos/cip-pro-small.png" alt="Logo" /> */}
            </div>
          ...
          >
            <div className="flex h-full flex-col">
              <div className="flex justify-between">
                <div className="relative h-10 aspect-[2/1]">
                  {/* <Image width={100} height={100} src="/logos/cip-pro-small.png" alt="Logo" /> */}
                </div>
